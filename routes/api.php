...
Route::delete('/deleteDiscipline/{id}', [DisciplineController::class, 'deleteDiscipline']);
...
Route::delete('/deleteSportsman/{id}', [SportsmanController::class, 'deleteSportsman']);
...
Route::delete('/deleteParticipation/{id}', [ParticipationController::class, 'deleteParticipation']);
